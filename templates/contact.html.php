<div class="glass-card auth-container" style="max-width: 600px;">
    ...
    <p style="margin-bottom: 1.5rem; color: var(--text-muted);">Have a question or issue with the platform? Send us a
        message.</p>
    ...
    <form action="https://api.web3forms.com/submit" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" id="name" name="name" class="form-control" required
                value="<?=isset($_SESSION['display_name']) ? htmlspecialchars($_SESSION['display_name']) : ''?>">
        </div>
